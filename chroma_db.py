...
# load chromadb collection (already populated by build_db.py)
...
st.write(" ")
st.write("Used to monitor client news.")
...
if "messages" not in st.session_state:
    st.session_state["messages"] = [
        ...
        {"role": "assistant", "content": "How can I help you? Ask me about interesting or important news about your clients."}
    ]
else:
